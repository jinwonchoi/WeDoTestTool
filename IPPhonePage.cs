...
{
	public partial class IPPhonePage : SamplePageBase
	{
        public IPPhonePage()
		{
			InitializeComponent();
        ...
        private void SelectAllButton_Click(object sender, EventArgs e)
        {
            ...
            if (!isTimerStarted)
            {
                timer1.Start();
                isTimerStarted = true;
                SelectAllButton.Text = "Timer Started.";
            }
            else
            {
                timer1.Stop();
                isTimerStarted = false;
                SelectAllButton.Text = "Timer Stopped.";
            }
        }
        int iTimer = 0;
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            SelectAllButton.Text = "Timer Started.:" + (iTimer % 5);

            if (iTimer % 5 == 0)
            {
                if (topMostFrm == null)
                    topMostFrm = new PopupTopMostForm();
                topMostFrm.TopMost = true; 
                topMostFrm.Show(this);
            }
            if (iTimer % 5 == 2)
            {
                if (topMostFrm == null)
